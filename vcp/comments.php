...
?>
	...
	<span class="comment_avatar">
		<?php if (function_exists('get_avatar') && get_option('show_avatars')) { echo get_avatar($comment, 64); } ?><br />
		<small><?php comment_author_link() ?> <br /> <?php comment_date() ?> <a href="#comment-<?php comment_ID() ?>">#</a><?php edit_comment_link(__("Edit This"), ' |'); ?></small>
	</span>
